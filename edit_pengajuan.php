        ...
        <div class="mb-3 position-relative" id="favorit_search_container">
            ...
            <div class="input-group shadow-sm rounded-3">
                ...
                <button type="button" class="btn btn-white bg-white border-start-0 border-end-0 text-muted" 
                        id="btnClearFavoritSearch" onclick="resetFavoritSearch()" style="<?= !empty($p['nama_pembeli']) ? 'display:inline-block;' : 'display:none;'; ?>" title="Bersihkan pencarian">
...
function calculateRow(idx) {
    const qtyElem = document.getElementById(`jumlah_${idx}`);
    ...
    const subtotal = Math.round(qty * harga * 100) / 100;
